...
def getTilesetID(id)
  if(TIMESENSITIVETILESETS.include?(id) && PBDayNight.isNight?)
...
if PBDayNight.isNight?
  ...
  when 4 #san cerigold town
    $game_map.fog_name = "San Cerigold Night Fog"
