#Part of this script is not being used. Its contents were merged into the
#Name-box script. Any modification of pbMessageDisplay should be done in
#Name-box
