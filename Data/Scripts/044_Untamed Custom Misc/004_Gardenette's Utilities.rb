...
=end
  ...
  loop do
    ...
    pbMessage(_INTL("\\ts[]Sometimes I get the feeling\\wtnp[#{20*2.5}] \\ts[]he's watching over me\\wtnp[#{20*2.5}]"))
    pbMessage(_INTL("\\ts[]and other times I feel like I'm a fool.\\wtnp[#{20*4}]"))
