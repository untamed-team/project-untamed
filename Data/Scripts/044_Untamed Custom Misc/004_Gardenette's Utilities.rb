...
######################################################################
###### Create a message window that doesn't automatically clear ######
######################################################################
def pbMessageNoClear(message, commands = nil, cmdIfCancel = 0, skin = nil, defaultCmd = 0, clear=false, &block)
  ret = 0
  msgwindow = pbCreateMessageWindowNoClear(nil, skin)
  #if commands
  #  ret = pbMessageDisplay(msgwindow, message, true,
  #                         proc { |msgwindow|
  #                           next Kernel.pbShowCommands(msgwindow, commands, cmdIfCancel, defaultCmd, &block)
...
def pbCreateMessageWindowNoClear(viewport = nil, skin = nil)
