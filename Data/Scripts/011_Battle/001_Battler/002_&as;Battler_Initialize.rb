class Battle::Battler
  ...
  # Creating a battler
  #=============================================================================
  def initialize(btl, idxBattler, notfake=true) # AI stuff #by low
    @battle      = btl
    @index       = idxBattler
    @captured    = false
    @dummy       = false
    ...
    pbInitBlank
    pbInitEffects(false) if notfake
  end
  ...
  def pbInitEffects(batonPass)
    if batonPass
      ...
      #GameData::Stat.each_battle { |stat| @stages[stat.id] = 0 } #moved to later #by low
    ...
    @effects[PBEffects::Yawn]                = 0
		# new effects #by low
    @effects[PBEffects::NoFlinch]            = 0
    @effects[PBEffects::ZealousDance]        = 0
