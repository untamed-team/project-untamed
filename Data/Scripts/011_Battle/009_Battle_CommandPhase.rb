  ...
  def pbCommandPhaseLoop(isPlayer)
    ...
    loop do
      ...
      loop do
        ...
        when 1    # Bag
					# items ban #by low
					if $game_variables[DIFFICULTYVAR]==0 && $game_variables[MAXITEMSVAR]>2 && @opponent
						pbDisplay(_INTL("3 items have already been used in this Trainer Battle!"))
					elsif $game_variables[DIFFICULTYVAR]>0 && @opponent
