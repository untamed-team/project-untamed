class Battle::Scene
  ...
  def pbCreateBackdropSprites
    ...
    # Put everything together into backdrop, bases and message bar filenames
		# water edits for Gardenette #by low
		if @battle.environment == :MovingWater   then backdropFilename = "water"
		elsif @battle.environment == :Puddle     then backdropFilename = "puddle"
		elsif @battle.environment == :Underwater then backdropFilename = "underwater"
		else
