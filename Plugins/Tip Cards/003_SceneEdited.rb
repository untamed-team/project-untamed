...
class AdventureGuide_Scene
    ...
    def pbStartScene
		...
		#@sprites["guide_background"].z = 99999
    ...
    def pbDrawTip
        ...
        info = Settings::TIP_CARDS_CONFIGURATION[tip] || nil
        if info
            text_y_adj = 64 + @sprites["guide_background"].y
            text_x_adj = 16 + @sprites["guide_background"].x + @sprites["guide_background"].width/2
            text_width_adj = 0
            pbSetTipCardSeen(tip)
            #if info[:Background]
            #    @sprites["background"].setBitmap(_INTL("Graphics/Pictures/Tip Cards/#{info[:Background]}"))
            ...
            if info[:Image]
                ...
                when :Top
                    ...
                    @sprites["image"].y = @sprites["guide_background"].y + 82
                    text_y_adj += @sprites["image"].height + 16
                when :Bottom
                    @sprites["image"].x = (@sprites["guide_background"].width/2 + @sprites["guide_background"].width/4 - @sprites["image"].bitmap.width/2)
                    @sprites["image"].y = @sprites["guide_background"].y + @sprites["guide_background"].height - @sprites["image"].bitmap.height - 38
                when :Left
                    @sprites["image"].x = @sprites["guide_background"].x + 16 + @sprites["guide_background"].width/2
                    @sprites["image"].y = @sprites["guide_background"].y + 82
                    text_x_adj += @sprites["image"].width + 16
                when :Right
                    @sprites["image"].x = @sprites["guide_background"].x + @sprites["guide_background"].width - @sprites["image"].bitmap.width - 16
                    @sprites["image"].y = @sprites["guide_background"].y + 82
                    text_width_adj -= @sprites["image"].width + 16
                end
                @sprites["image"].visible = true
