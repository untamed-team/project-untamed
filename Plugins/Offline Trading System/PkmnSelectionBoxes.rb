class PokemonGlobalMetadata
	attr_accessor   :currentlyTrading
	attr_accessor   :tradingOfferedPkmn
end

class PokemonStorageScreenForTrading
  attr_reader :scene
  attr_reader :storage
    ...
    when 0   # Organise
      ...
      loop do
        ...
        if selected.nil?
          ...
          next if pbConfirm(_INTL("Continue choosing a Pokemon to trade?"))
          break
...
end #class PokemonStorageScreenForTrading

class PokemonStorageSceneForTrading
...
end #class PokemonStorageSceneForTrading