class CrustangRacing
	...
	def self.drawContestants
		...
		@enteredCrustang.moves = [Pokemon::Move.new(:PROTECT),Pokemon::Move.new(:MUDSLAP),Pokemon::Move.new(:ROCKTOMB),Pokemon::Move.new(:HELPINGHAND)]
		filename = "Followers/CRUSTANG"
