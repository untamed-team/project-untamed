class CrustangRacing
	...
	def self.drawContestants
		...
		@enteredCrustang.moves = [Pokemon::Move.new(:LEER),Pokemon::Move.new(:RAPIDSPIN),Pokemon::Move.new(:REST),Pokemon::Move.new(:HELPINGHAND)]
		filename = "Followers/CRUSTANG"
