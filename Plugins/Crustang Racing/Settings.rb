...
speedUpTarget:   {EffectName: "Speed Up", EffectCode: "SpeedUpTarget", Description: "Speed up a target racer, making them more likely to hit obstacles.", AssignedMoves: [:HELPINGHAND, :SWAGGER, :TAUNT, :FOULPLAY],},
